...
namespace rentid
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //ErrorDescriber -> Hata Mesajlarının Türkçeleştirilmesi
            //DefaultTokenProviders -> Şifre yenileme için token oluşturma
            ...
            }).AddErrorDescriber<customIdentityErrorDescribber>().AddDefaultTokenProviders().AddEntityFrameworkStores<appDbContext>();
